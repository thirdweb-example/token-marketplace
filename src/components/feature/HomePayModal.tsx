...
const HomePayModal = ({ open, onClose, token, client }: { open: boolean, onClose: () => void, token: any, client: any }) => {
  if (!open || !token) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" onClick={onClose}>
      <div
        className="relative w-full max-w-md mx-4 rounded-xl border border-[#232329] bg-[#111] shadow-2xl p-0"
